...
export function mandateAccount(over: Partial<MandateAccount> = {}): MandateAccount {
  ...
  return {
    ...
    observerSet: k(3),
    vault: k(4),
    createdAt: BigInt(START - 1_500),
    biddingEndsAt: BigInt(START - 600),
    startAt: BigInt(START),
    epochSeconds: BigInt(EPOCH_SECONDS),
    totalEpochs: 72,
    endAt: BigInt(START + 72 * EPOCH_SECONDS),
    acceptanceCutoff: BigInt(START - 900),
    positionLockAt: BigInt(START - 120),
    algorithmVersion: 1,
    ...
    acceptedRewardRaw: 900_000_000n,
    baseEpochRewardRaw: 900_000_000n / 72n,
    finalEpochExtraRaw: 900_000_000n % 72n,
    finalizedEpochs: 0,
    compliantEpochs: 0,
